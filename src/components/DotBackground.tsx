...
export function DotBackgroundDemo() {
  return (
    <div className="relative flex flex-col h-[50rem] w-full items-center justify-center bg-white dark:bg-black">
      ...
      <p className="relative text-4xl font-bold sm:text-7xl">
        <ScrollFloat
                        animationDuration={1}
                        ease='back.inOut(2)'
      ...
      <p className="w-[70%] mt-4 text-sm  text-slate-300"> 
        <ScrollReveal
                      ...
                      baseRotation={0}
                      blurStrength={10}
                      >Hi! I&apos;m a passionate MERN Stack Developer with a strong focus on building modern, scalable, and responsive web applications. With hands-on experience in MongoDB, Express.js, React, and Node.js, I bring both frontend fineness and backend logic together to deliver seamless user experiences.
